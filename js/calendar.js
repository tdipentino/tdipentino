...
$(document).ready(function() {
	...
	$(document).on('click','.c-month-arrow-left',offsetcalendar);
	$(document).on('click','.c-month-arrow-right',offsetcalendar);
...
(function ( $ ) {
    $.fn.calendar = function(array, options) {
    	$this = this;
		$this.append('<div class="c-month-view"><div class="c-month-arrow-left" data-dir="left">&#171;</div><p></p><div class="c-month-arrow-right" data-dir="right">&#187;</div></div><div class="c-holder"><div class="c-grid"></div><div class="c-specific"><div class="specific-day"><div class="specific-day-info" i="day"></div><div class="specific-day-info" i="month"></div></div><div class="s-scheme"></div></div></div>');
